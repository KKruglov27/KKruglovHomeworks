...
class WordsFinder:
    ...
    def find(self, word):
        ...
        for name, words_list in self.all_dicts.items():
            ...
            continue
        return (f"Word's index '{word.upper()}' in file:", self.word_index,
                f"self.All_indexes '{word.upper()}' in file:", self.word_indexes)
    ...
    def count(self, word):
        ...
        for name, words_list in self.all_dicts.items():
            ...
            continue
        return f"Words count '{word.upper()}' in file: ", self.word_count
