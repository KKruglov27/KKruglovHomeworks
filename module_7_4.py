...
score_1 = 53
score_2 = 52
team1_time = 2230.34003
team2_time = 2230.34002
...
if score_1 == score_2 and team1_time == team2_time:
    ...
    (print(f'Результат битвы: {challenge_result} {team2_name if score_2 > score_1 else team1_name}!' or
f'Результат битвы: {challenge_result} {team2_name if score_2 == score_1 and team1_time > team2_time else team1_name}!')
and f'Результат битвы: {challenge_result} {team1_name if score_2 == score_1 and team1_time < team2_time else team2_name}!')
