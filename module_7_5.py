...
Пока что я с ней не разобрался, загружал на репозиторий несколько запакованных файлов,
но так предоставлять свою домашнюю работу нельзя, только одним файлом.py.

В любом случай лучше запустить нижние конструкции из отдельного .py.
"""
